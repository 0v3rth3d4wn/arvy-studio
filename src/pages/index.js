  ...
  <>
    <ReactPageScroller>
      ...
      >
        ...
        <p>
          We breathe life into our visualisations by paying special attention to
          the little things that make a difference : a sun beam, a reflexion.
        </p>
        <FeaturesList>
          <li>Still images</li>
          <li>360 panoramas</li>
      ...
      >
        <p>
          ...
          one is just as set of walls and some materials, the second sounds like
          music, smells like breakfast and feels like a warm embrace.
        </p>
        <p>
          We strive to create our interiors visualisations not just as renders,
          but glimpses into a beautiful future.
        </p>
        <FeaturesList>
          <li>Still images</li>
          <li>360 panoramas</li>
